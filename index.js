...
const descriptionText = `We’ve raised a total of $${totalRaised.toLocaleString()} for ${GAMES_JSON.length}
 ${GAMES_JSON.length === 1 ? "game" : "games"}. Currently, ${unfundedCount} ${unfundedCount === 1 ? 
